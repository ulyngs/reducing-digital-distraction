...
On a laptop, limit the amount of information available to just what you need for a task.
...
Here's a YouTube tutorial showing how to do this:

<iframe width="560" height="315" src="https://www.youtube.com/embed/uRtWGeh5rJE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
For example, limit your first page of apps to only apps you use for quick in-and-out tasks - then move the rest, especially those you find yourself using mindlessly, off the first page and into folders.
