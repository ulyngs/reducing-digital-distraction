...
## Goal reminders on new tabs
On **laptop**, you can replace the content of new tabs and use this to remind you of your goals.
...
Search through the browser extension stores for a similar extension that might be useful to you:
...
On **Firefox**, [Daily Motivational Tab](https://addons.mozilla.org/en-US/firefox/addon/daily-motivational-tab/?src=search) will add random motivational images to new tabs:

```{r}
knitr::include_graphics("figures/firefox_motivation.png")
```

On **Firefox**, [Motivation](https://addons.mozilla.org/en-US/firefox/addon/motivation-new-tab/?src=search) will add a counter of your age to new tabs to remind you that life is precious:

```{r, out.width="80%", fig.align='center'}
knitr::include_graphics("figures/firefox_motivation_clock.png")
```
...
## Replace Facebook's newsfeed with a todo-list (Chrome only)
...
## Automatically redirect yourself
...
On **Firefox**, [Nudge](https://addons.mozilla.org/en-US/firefox/addon/nudge-me/?src=search) does the same thing:

```{r}
knitr::include_graphics("figures/firefox_nudge.png")
```
